...
export const products: Product[] = [
  ...
  { id:"zara-candy",number:"08",name:"GULNAAR",slug:"gulnaar",subtitle:"Candied pear / strawberry / vanilla",atmosphere:"Sweet memories, bottled.",description:"GULNAAR is a bright, sweet perfume oil with a playful blend of candied pear, strawberry and soft vanilla. Inspired by the scent direction of Zara Candy, it balances fruity sweetness with a smooth, comforting finish.",inspirationLine:"Inspired by Zara Candy",searchAliases:["Zara Candy"],character:["Sweet","Fruity","Vanilla","Bright"],suitableFor:commonUses,suitability:"unisex",color:"#e3a9a2",image:"/images/products/zara-candy.webp",status:"active",enabledSizes:[6,12],prices:{6:59900,12:84900} },
