  ...
  public: {
    Tables: {
      products: {
        ...
        Insert: { id?: string; product_number: string; name: string; slug: string; subtitle?: string; description?: string; short_description?: string; status?: "draft" | "coming_soon" | "active" | "sold_out" | "archived"; notes_verified?: boolean; updated_at?: string };
